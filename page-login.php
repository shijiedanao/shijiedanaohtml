...
<div class="container">
    <div class="login-container">
        <h2>登录</h2>
        <form class="login-form" id="verifyLoginForm">
            ...
            <div class="form-options">
                <a href="<?php echo esc_url(home_url('/?page_id=213')); ?>" class="forgot-password">忘记密码？</a>
            </div>
            <button type="submit" class="login-btn">登录</button>
            <div class="register-link">
                还没有账号？<a href="<?php echo esc_url(home_url('/?page_id=108')); ?>">立即注册</a>
            </div>
            <div class="wechat-register">
                <div class="divider">
                    <span>或</span>
                </div>
                <button type="button" class="wechat-btn" id="wechatLoginBtn">
